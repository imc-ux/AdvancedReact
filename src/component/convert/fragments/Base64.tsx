...
export default function Base64Convert() {
  ...
  function onPictureSubmitChangeHandler(event: React.ChangeEvent<HTMLInputElement>) {
  ...
  function onPictureConvertInputChangeHandler(event: React.ChangeEvent<HTMLTextAreaElement>) {
  ...
  function Imgdisplay() {
    if (picturesrc === '') {
      ...
      return <img src={picturesrc} onClick={() => uploadRef.current.click()} className="img-src" />;
    }
  }
      ...
      <div className="Base64-div">
        <div className="flex-div">
          <div className="div-minWidth">
            <div className="text-Base64">图片/Base64转换</div>
            <div className="div-left" onDragOver={onImageDragOverHandler} onDrop={onImageDropHandler}>
              <input
                ref={(node) => {
            ...
            <Button
              ...
              className="button-base64"
              onClick={onBase64ConvertPictureClickHandler}
            >
              Base64转换图片
            </Button>

            <div className="div-left" onMouseOver={onPictureButtonshowMouseoverHandler} onMouseOut={onPictureButtonHiddenMouseOutHandler}>
              <TextArea
                rows={10}
                value={picture}
              ...
              <div className="picture-button-div">
                <CopyTwoTone className="base_copy" id="picturebuttonshow" onClick={oncopyPictureConvertClickHandler}></CopyTwoTone>
              </div>
          ...
          <div className="div-minWidth">
            <div className="text-Base-code">Base64编码/解码</div>
            <div style={{ marginTop: 26 }}>
              <div className="div-right">
                <TextArea rows={10} onChange={oninputChangeHandler} className="textarea_input" style={{ borderRadius: 10, height: 230 }}></TextArea>
              </div>
              <div className="flex-div">
                <Button
                  className="button-base64-top"
                  style={{
                    color: '#FFFFFF',
                    paddingLeft: 10,
                    height: 25,
                ...
                <Button
                  className="button-base64-bottom"
                  style={{
                    color: '#FFFFFF',
                    paddingLeft: 10,
                    height: 25,
              ...
              <div className="div-right" onMouseOver={onTextButtonShowMouseOverHandler} onMouseOut={onTextButtonHiddenMouseOutHandler}>
                <TextArea
                  rows={10}
                  value={inputResult}
                  readOnly
                ...
                <div className="text-convert-button-div">
                  <CopyTwoTone className="base_copy_bottom" id="TextButtonShow" onClick={oncopyTextConvertClickHandler}></CopyTwoTone>
