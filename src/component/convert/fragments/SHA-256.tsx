...
export default function SHA1() {
  ...
  function onSHAEntryptionChangeHandler(event: React.ChangeEvent<HTMLTextAreaElement>) {
  ...
  return (
    <div>
      ...
      <div className="col-border" onMouseOver={onCopyButtonShowHandler} onMouseOut={onCopyButtonHiddenHandler}>
        <Row gutter={0}>
          <Col span={30}>
            <TextArea rows={10} style={{ width: 680, borderRadius: 10 }} placeholder="这里是加密结果" value={sHAResult} readOnly />
          </Col>
        </Row>
        <div>
